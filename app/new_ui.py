...
def _pdf_school_header(school_row, styles, title, subtitle=""):
    ...
    table = Table([[logo_flowable, text, right]], colWidths=[28*mm, None, 48*mm])
    table.setStyle(TableStyle([
        ("VALIGN",(0,0),(-1,-1),"MIDDLE"),
        ("LINEBELOW",(0,0),(-1,-1),1.4,colors.HexColor("#0b3d91")),
        ("LINEABOVE",(0,0),(-1,-1),0.8,colors.HexColor("#f4b400")),
...
.blank-marksheet-card{{background:#fff;overflow:hidden}}.blank-doc-head{{display:flex;align-items:center;gap:14px;border-top:2px solid #f4b400;border-bottom:3px solid #0b3d91;padding:8px 4px 10px}}.blank-brand-left{{display:flex;align-items:center;gap:12px;flex:1}}.blank-doc-logo{{width:76px;height:62px;display:flex;align-items:center;justify-content:center}}.blank-doc-logo img{{max-width:72px;max-height:58px;object-fit:contain}}.blank-school{{font-size:20px;font-weight:900;text-transform:uppercase;color:#0b3d91}}.blank-contact{{font-size:9px;color:#334155;margin-top:4px;line-height:1.45}}.blank-doc-right{{font-size:10px;color:#0b3d91;line-height:1.7;min-width:135px}}.blank-title{{font-size:16px;font-weight:900;text-align:right;color:#0b3d91}}.blank-meta{{font-size:11px;font-weight:800;padding:8px 4px;border-bottom:1px solid #111827}}.blank-scroll{{overflow-x:auto;padding-bottom:8px}}.blank-marksheet{{border-collapse:collapse;width:max-content;min-width:100%;font-family:Arial,sans-serif}}.blank-marksheet th,.blank-marksheet td{{border:1px solid #111;padding:7px 8px;text-align:center;font-size:10px;white-space:nowrap;height:28px}}.blank-marksheet th{{background:#0b3d91;color:#fff;font-weight:900}}.blank-marksheet th:first-child,.blank-marksheet td:first-child{{width:58px;min-width:58px}}.blank-marksheet th:nth-child(2),.blank-marksheet td:nth-child(2){{width:125px;min-width:125px;max-width:125px;text-align:left}}.blank-marksheet th:not(:first-child):not(:nth-child(2)){{min-width:52px;width:52px}}.blank-marksheet .blank-sub{{font-size:8px}}.blank-marksheet .blank-cell{{height:30px;min-width:72px}}.blank-note{{font-size:9px;color:#64748b;margin-top:8px}}
