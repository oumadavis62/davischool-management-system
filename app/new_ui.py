...
def _pdf_build(story, pagesize, title):
    ...
    def draw_footer(canvas, doc):
        ...
        footer = "D-School Management System  ·  Generated: %s  ·  Page %d" % (
                    ...
                    for start_at in range(0, len(text_line), 115):
                        if y < 18 * mm:
                            ...
                            c.drawCentredString(
                                pagesize[0] / 2,
                                7 * mm,
                                "D-School Management System - Generated: %s - Page %d"
...
function printDocument(){
  ...
  var footer='<div class="print-footer"><i>D-School Management System</i> · Generated: '+generatedAt+'</div>';
...
def report_cards_class_preview(request: Request, exam_ids: str="", class_id: str=""):
    ...
    try:
        ...
        footer_html="<div class='print-footer'><i>D-School Management System</i> · Generated: %s</div>" % generated_at
        for st in students:
            try:
                result=_student_result_for_assessments(cur,sid,int(st["id"]),selected_exam_ids,grading_rules,overall_rules)
            except Exception as exc:
