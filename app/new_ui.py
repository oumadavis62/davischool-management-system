...
.blank-marksheet-card{{background:#fff;overflow:hidden}}.blank-doc-head{{display:flex;align-items:flex-start;gap:14px;border-top:2px solid #2E8B57;border-bottom:3px solid #176B3A;padding:8px 4px 10px}}.blank-brand-left{{display:flex;align-items:flex-start;gap:12px;flex:1;min-width:0}}.blank-doc-logo{{width:86px;height:70px;display:flex;align-items:center;justify-content:center;flex:0 0 86px}}.blank-doc-logo img{{max-width:82px;max-height:66px;object-fit:contain}}.blank-school{{font-size:20px;line-height:1.15;font-weight:900;text-transform:uppercase;color:#176B3A}}.blank-contact{{font-size:10px;color:#334155;margin-top:5px;line-height:1.55}}.blank-contact div{{display:block;margin:1px 0}}.blank-doc-right{{font-size:10px;color:#176B3A;line-height:1.65;min-width:155px}}.blank-doc-right div{{display:block;margin:1px 0}}.blank-title{{font-size:16px;font-weight:900;text-align:right;color:#176B3A}}.blank-meta{{font-size:11px;font-weight:800;padding:8px 4px;border-bottom:1px solid #111827}}.blank-scroll{{overflow-x:auto;padding-bottom:8px}}.blank-marksheet{{border-collapse:collapse;width:max-content;min-width:100%;font-family:Arial,sans-serif}}.blank-marksheet th,.blank-marksheet td{{border:1px solid #111;padding:7px 8px;text-align:center;font-size:10px;white-space:nowrap;height:28px}}.blank-marksheet th{{background:#176B3A;color:#fff;font-weight:900}}.blank-marksheet th:first-child,.blank-marksheet td:first-child{{width:58px;min-width:58px}}.blank-marksheet th:nth-child(2),.blank-marksheet td:nth-child(2){{width:125px;min-width:125px;max-width:125px;text-align:left}}.blank-marksheet th:not(:first-child):not(:nth-child(2)){{min-width:52px;width:52px}}.blank-marksheet .blank-sub{{font-size:8px}}.blank-marksheet .blank-cell{{height:30px;min-width:72px}}.blank-note{{font-size:9px;color:#64748b;margin-top:8px}}
@media(max-width:900px){{.blank-controls{{grid-template-columns:1fr 1fr}}}}
@media print{{@page{{size:A4 landscape;margin:8mm}}body{{background:#fff;color:#172033}}.side,.top,.no-print,.page>h1,.page>.muted{{display:none!important}}.main{{margin-left:0!important;padding:0!important}}.page{{padding:0!important;margin:0!important;max-width:none!important}}.blank-marksheet-card{{border:0!important;box-shadow:none!important;margin:0!important;padding:0!important}}.blank-scroll{{overflow:visible!important}}.blank-marksheet{{width:100%!important}}.blank-marksheet th,.blank-marksheet td{{font-size:8px;padding:5px;border-color:#176B3A}}.blank-marksheet th{{background:#176B3A;color:#fff}}.blank-school{{font-size:16px}}.blank-title{{font-size:13px}}}}
</style>"""
