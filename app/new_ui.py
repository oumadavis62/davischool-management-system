...
function printReportCard(){
  ...
  w.document.close();w.focus();setTimeout(function(){w.print();},300);
    ...
    print_btn=("<button class='btn' style='margin-top:8px' onclick='printReportCard()'>Print Report</button> <a class='btn' style='display:inline-block;margin-top:8px;text-decoration:none' href='/app/report-cards/pdf?exam_id={eid}&student_id={stid}'>⬇️ Download PDF</a>") if report_final else ""
