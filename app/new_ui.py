...
function printDocument(){
  ...
  setTimeout(function(){w.print();},300);
    ...
    body = (
        ...
        "".join("<label class='metric-label'><input type='checkbox' class='overall-choice' value='%s' %s onchange='document.getElementById("selectedOverallMetrics").value=Array.from(document.querySelectorAll(".overall-choice:checked")).map(function(x){return x.value}).join(",")'> %s</label>" % (m,"checked" if m in overall_metric_list else "",{"mks":"MKS","pts":"PTS","avg":"AVG %","grade":"GRD","pos":"POS"}[m]) for m in ("mks","pts","avg","grade","pos")) +
...
def class_analysis_pdf(request: Request, exam_id: str = "", exam_ids: str = "", class_id: str = ""):
    ...
    try:
        ...
        t=Table(data,colWidths=[70*mm,25*mm,30*mm,30*mm,30*mm],repeatRows=1);t.setStyle(TableStyle([("GRID",(0,0),(-1,-1),.4,colors.black),("BACKGROUND",(0,0),(-1,0),colors.HexColor("#176B3A")),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),("FONTSIZE",(0,0),(-1,-1),8)]));story += [t,Spacer(1,8),Paragraph("Learner Ranking",styles["normal"])]
        ...
        t=Table(data,colWidths=[20*mm,30*mm,65*mm,25*mm,30*mm,25*mm],repeatRows=1);t.setStyle(TableStyle([("GRID",(0,0),(-1,-1),.4,colors.black),("BACKGROUND",(0,0),(-1,0),colors.HexColor("#176B3A")),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),("FONTSIZE",(0,0),(-1,-1),8)]));story.append(t)
...
def student_analysis_pdf(request: Request, exam_id: str = "", exam_ids: str = "", student_id: str = ""):
    ...
    try:
        ...
        t=Table(data,colWidths=[85*mm,30*mm,30*mm,30*mm],repeatRows=1);t.setStyle(TableStyle([("GRID",(0,0),(-1,-1),.4,colors.black),("BACKGROUND",(0,0),(-1,0),colors.HexColor("#176B3A")),("TEXTCOLOR",(0,0),(-1,0),colors.white),("FONTNAME",(0,0),(-1,0),"Helvetica-Bold"),("FONTSIZE",(0,0),(-1,-1),9)]));story.append(t)
