...
app = FastAPI()
app.add_middleware(SessionMiddleware, secret_key="davischool-v60-full-two-parts")
...
async def school_record_save(request: Request):
    ...
    con.commit(); con.close()
    return RedirectResponse("/school/dashboard",303)
