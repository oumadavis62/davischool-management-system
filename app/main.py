      ...
      <div style='display:grid; grid-template-columns:360px 1fr; gap:16px'>
        <div style='background:white; border:1px solid #e2e8f0; border-radius:14px; padding:16px; height:fit-content'>
          ...
          <form method='post' action='/school/teachers/add'>
            ...
            <select name='role' required class='input-field'><option value=''>Select Role ▼</option><option>Principal</option><option>Deputy Principal</option><option>Class Teacher</option><option>Senior Teacher</option><option>Director of Studies</option><option>Teacher</option></select>
