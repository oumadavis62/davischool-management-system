...
def dashboard(request: Request):
    ...
    body=f"""<div class="grid"><div class="card"><h3>Students</h3><h1>{sc}</h1><a href="/students" class="btn btn-primary btn-sm">View</a></div><div class="card"><h3>Teachers</h3><h1>{tc}</h1><a href="/teachers" class="btn btn-primary btn-sm">View</a></div><div class="card"><h3>Fees</h3><h1>KSh {fc}</h1><a href="/fees" class="btn btn-primary btn-sm">View</a></div><div class="card"><h3>Marks Entry</h3><p>Click cell to edit marks quickly</p><a href="/marks" class="btn btn-primary btn-sm">Enter Marks</a></div></div><div class="card"><h3>Recent Students</h3><table><tr><th>ADM</th><th>Name</th><th>Class</th></tr>{rows}</table></div>"""
