    ...
    if tab == "personal":
        ...
        <div style='background:white; border:1px solid #e2e8f0; border-radius:16px; padding:20px'>
          ...
          <form method='post' action='/profile/update'>
            ...
            <input name='phone' value="+254748588874" style='width:100%; padding:11px; border:1px solid #e2e8f0; border-radius:10px; margin:4px 0 12px; background:#f0f9ff'>
            <label style='font-size:11px; font-weight:700; color:#475569'>🏫 Organization</label>
            <input value="Davischool Platform" disabled style='width:100%; padding:11px; border:1px solid #e2e8f0; border-radius:10px; margin:4px 0 12px; background:#f0f9ff'>
            <div style='text-align:right; margin-top:16px'><button style='background:#0f172a; color:white; padding:10px 18px; border:none; border-radius:10px; font-weight:700; font-size:12px'>💾 Save Changes</button></div>
          </form>
        </div>"""
    elif tab == "security":
        right_card = f"""
        <div style='background:white; border:1px solid #e2e8f0; border-radius:16px; padding:20px'>
          ...
          <form method='post' action='/profile/change-password'>
            ...
            <div style='text-align:right; margin-top:16px'><button style='background:#0f172a; color:white; padding:10px 18px; border:none; border-radius:10px; font-weight:700; font-size:12px'>🔒 Update Password</button></div>
          </form>
        </div>"""
    else:
        log_rows_html = ""
            ...
            <div>
                ...
                <div style='background:#0f172a; border-radius:14px; padding:16px; color:white'>
                    ...
                    <div style='background:#1e293b; border-radius:10px; padding:12px'>
                        <div style='font-size:10px; color:#94a3b8; letter-spacing:0.5px; margin-bottom:6px'>🔧 PLATFORM HEALTH</div>
                        <div style='color:#22c55e; font-weight:800; font-size:14px'>✅ 99.9% Uptime</div>
                        <div style='height:4px; background:#334155; border-radius:10px; margin-top:8px'><div style='width:99%; height:100%; background:#22c55e; border-radius:10px'></div></div>
                    </div>
                </div>
            </div>
        </div>
...
def school_dashboard(request: Request):
    ...
    html = f"<div style='padding:20px'><h2>MATOKEO ANALYTICS 🚀</h2><p>Students {sc} | Classes {cc} | Exams {ec}</p></div>"
